...
<head>
  ...
  <style>
    ...
    /* CONTROLES (visual) */
    .controls {
      background: #ffffff; /* controles em fundo claro */
      padding: 12px 20px;
      display: flex;
      align-items: center;
      gap: 16px;
...
<ul id="AulasMod" >
  ...
  <main class="player" >
    ...
    <div class="aula-descricao">
      ...
      <p id="descAula">
        Nesta aula você irá aprender os conceitos iniciais do treinamento,
        entender o objetivo do curso e como navegar entre os módulos e aulas.
      </p>
    </div>
...
function abrirModulo(id) {
    ...
    ul.innerHTML +=
        "<li style='padding-left:25px;' onclick=\"abrirAula('" + aula.id + "')\">" +
...
function abrirAula(id) {
    ...
    .then(function(dados) {
        ...
        if (dados && dados.dados && dados.dados.desc_midia) {
            ...
            document.getElementById("descAula").innerText = "";
        }
