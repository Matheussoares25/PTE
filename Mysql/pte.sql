...
--
-- Host: 127.0.0.1
-- Tempo de geração: 26/03/2026 às 11:36
...
(231, 'funcionario@email.com', '$2y$12$nqR1Y5NuTDqfDiIFFgwNCOsKfMwgWFXmxm8ugIimVn3WY4JAfzyCi', 1, NULL, '7f5a84bd9a0b7ca348eefca5afb49a6eb0c79ab5a60554fb2e6bd8af6f14f8ad', '1', 'funcionario', 1),
(232, 'pte@pte', '$2y$12$EjcoXphCxCsyJBDBKnmHEeRdz43mJtvmspQRc16I.kMyMcqGCPS3O', 1, NULL, 'bc1bbd1e92bdb1a3447e7e4e0c02687cbb69c77c721a5c58d8441c34bf49ee43', '2', 'pte', 1);
...
ALTER TABLE `alternativas`
  ADD PRIMARY KEY (`id`),
  ADD KEY `FK_alternativas_questoes` (`id_questao`),
  ADD KEY `FK_alternativas_aulas` (`id_prova`);
...
ALTER TABLE `progress`
  ...
  ADD KEY `FK_progress_usuarios` (`id_user`);
...
ALTER TABLE `questoes`
  ADD PRIMARY KEY (`id`),
  ADD KEY `FK_questoes_aulas` (`id_prova`);
...
--
ALTER TABLE `candidaturas`
  ADD CONSTRAINT `FK_candidaturas_usuarios` FOREIGN KEY (`id_user`) REFERENCES `usuarios` (`id`),
  ADD CONSTRAINT `FK_candidaturas_vagas` FOREIGN KEY (`id_vaga`) REFERENCES `vagas` (`id`);
